...
public class Warship extends Ship {
    ...
    public Warship(String name, String currentPort, double maxSpeed, double maxCapacity, double currentLoad, String typeOfWeapon, String interactsWith, String shipClass) {
